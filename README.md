# w7sfws-wp-endpoint-scanner

**w7sfws-wp-endpoint-scanner** is a Python-based static analysis tool designed to scan WordPress source code and identify HTTP mutation endpoints such as `POST`, `PUT`, and `PATCH`.  
